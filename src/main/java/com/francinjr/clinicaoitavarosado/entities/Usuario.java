...
public class Usuario implements UserDetails, Serializable {
	...
	// Os outros atributos como email!?
	...
	@Override
	public int hashCode() {
		return Objects.hash(accountNonExpired, accountNonLocked, credentialsNonExpired, currentVerificationCode, email,
				enabled, id, password, permissions, userName);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(accountNonExpired, other.accountNonExpired)
				...
				&& Objects.equals(currentVerificationCode, other.currentVerificationCode)
